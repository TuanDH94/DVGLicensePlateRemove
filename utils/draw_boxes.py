...
def draw_boxes(image, boxes, box_classes, class_names, scores=None):
    ...
    font = ImageFont.truetype(
        font='/opt/tuandh/code/LicensePlateRemove/YAD2K/dvg/font/FiraMono-Medium.otf',
    ...
    for i, c in list(enumerate(box_classes)):
        ...
        crop_box.append((left, top, right, bottom))
    ...
    return np.array(image), origin_image, crop_box
